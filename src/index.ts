...
export { default as BackdropDisabler } from "./primitives/BackdropDisabler";
export * from "./primitives/BackdropDisabler";
...
export { default as HandleClickOutside } from "./primitives/HandleClickOutside";
export * from "./primitives/HandleClickOutside";

export { default as Icon } from "./primitives/Icon";
export * from "./primitives/Icon";

export { default as ImageWithDefault } from "./primitives/ImageWithDefault";
export * from "./primitives/ImageWithDefault";
...
export { default as Password } from "./primitives/Input/Password";
export * from "./primitives/Input/Password";
...
export { default as TypographyLink } from "./primitives/Typography/TypographyLink";
